...
d = 2*lmbda; % espaciado
elementPos = (0:N-1)*d;         
stvmat = steervec(elementPos, azimuth);

[m,n] = size(stvmat);
fprintf('stvmat = %d × %d  (filas × columnas)\n', m, n);
...
w_opt = x_opt(1:N) + 1i*x_opt(N+1:end);
